...
public class PointEditImageActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_point_edit_image);
		// Show the Up button in the action bar.
		setupActionBar();
		
		currentRoadBook = MainActivity.currentRoadBook;
		
		pointImageView = (ImageView) findViewById(R.id.point_point_edit_image);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.point_edit_image, menu);
		return true;
	}
	...
	// Toast
    private static final String TAG = PointEditImageActivity.class.getSimpleName();
